...
pii_sanitized: true
tags: [resume, experience, skills, education, projects]
source_file: "/mnt/data/Resume-Vaishak_Menon.pdf"
---
...
Graduate student in Computer Science with hands-on experience deploying cloud-based solutions to GCP using Terraform and deploying applications to Kubernetes. Demonstrated teaching and mentorship skills as a Teaching Assistant, coupled with industry exposure from multiple Infrastructure Internships.
...
- Built and tuned a retrieval-augmented chatbot with reproducible evals on SQuAD v2 (500 examples).
- Results: Pareto-frontier generative settings (**F1 ≈ 0.54**, **NoAns ≈ 0.92**, **p50 ≈ 130 ms**), and retrieval **Recall@5 ≈ 0.85**, **Hit@1 ≈ 0.65**.

## GPT From Scratch

- Developed a decoder-only flash transformer architecture in Python. One version of the model is available on Hugging Face.

## Music Genre Classification

- Built a CNN-based model to classify audio spectrograms, improving accuracy by **+5–10%** over traditional baselines (k-NN, SVM, Random Forest).
...
- **DevOps / Cloud:** Kubernetes, Terraform, Docker, Google Cloud Platform
- **Programming:** Python, Rust, JavaScript/TypeScript, Java, C
- **Data / ML:** PSQL, MongoDB, Transformers, RAG, ChromaDB, LangGraph, Llama-3 via Ollama
- **Tooling:** FastAPI, Next.js, Tailwind, GitHub Actions
